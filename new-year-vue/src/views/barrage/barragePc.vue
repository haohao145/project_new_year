<template>
  <div
    class="aaa barrage-bg barrages-drop dmbg barrages"
...
<style lang="less" >
.barrage-bg {
  background: url(../../assets/img/systemImg/dmbg-l.jpg) no-repeat center/100%
    100%;
}
.barragebgh {
  background: url(../../assets/img/systemImg/dmbg-lh.jpg) no-repeat center/100%
    100%;
}
.barrages-drop {
  .blue {
...
.barrages .baberrage-item .baberrage-msg {
